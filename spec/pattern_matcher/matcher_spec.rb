  ...
  describe Matcher do
    ...
    describe "::match_pattern_in_text" do
      ...
      it "should return nil when given valid pattern and nil text" do
        Matcher.match_pattern_in_text(/hello/, nil).should be_false
      end

      it "should match when pattern is in text" do
        Matcher.match_pattern_in_text(/hello/, "hello world").should be_true
      end

      it "should not match when pattern is not in text" do
        Matcher.match_pattern_in_text(/hello/, "goodbye world").should be_false
      end
    end
